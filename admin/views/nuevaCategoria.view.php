...
<?php include_once 'templates/cabecera.php' ?>
  ...
  <main class="container pb-5 admin">
  	<div class="d-flex justify-content-between align-items-center py-4">
		...
		<h3 class="my-4">Nueva categoria</h3>
		<!-- ////// CAMPOS A RELLENAR ////// -->
		<div class="pb-5">
			<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST" enctype="multipart/form-data" class="row g-3"> <!-- enctype: permite enviar archivos a través del formulario -->
				<div class="col-12">
					...
					<input type="text" name="categoria" id="categoria" class="form-control mb-2" placeholder="Nombre de la categoria" 
										value="<?php if(isset($_POST['submit']) && !empty($categoria)) echo $categoria; ?>">
				</div>
			  <!-- ////// MOSTRAR ERRORES ////// -->
