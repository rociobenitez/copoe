  ...
  <div class="container-fluid mt-2">
    ...
    <div id="contact-links" class="container-fluid d-flex flex-wrap justify-content-end">
      <ul class="nav align-items-center position-relative">
        ...
        <!-- /// ENLACES CONTACTO /// -->
        <!-- <li class="nav-item">
          <a href="tel:000000000" class="nav-link link-contact px-2">
            <i class="bi bi-telephone-fill mx-1"></i> 000 000 000
          </a>
        </li>
        <li class="nav-item">
          <a href="mailto:info@copoe.es" class="nav-link link-contact ps-2 me-4">
            <i class="bi bi-envelope-fill mx-1"></i> info@copoe.es
          </a>
        </li> -->
        <?php endif ?>

        <!-- Solo se muestra el carrito si está iniciada la sesión --> 
        <?php if(isset($_SESSION['usuario'])): ?> 
        ...
        <li id="liCarrito"
          ...
          <p>
            <i id="carritoIcon" class="bi bi-bag-fill btn btn-5 px-3 mt-3 me-2 text-center" ></i>
          </p>
          <div id="carrito" class="d-none p-4 mt-5 position-absolute top-0 end-0">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <ul class="navbar-nav ms-auto my-auto ">
            ...
            <!-- <div class="d-flex mt-lg-0 mt-2"> -->
              ...
              <li class="nav-item my-lg-auto mt-sm-2">
                <a href="registro.php" role="button"
